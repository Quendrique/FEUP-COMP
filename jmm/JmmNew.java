/* JmmNew.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. JmmNew.java */
import java.io.BufferedReader;
import java.io.FileReader;
import java.io.IOException;

public class JmmNew/*@bgen(jjtree)*/implements JmmNewTreeConstants, JmmNewConstants {/*@bgen(jjtree)*/
  protected static JJTJmmNewState jjtree = new JJTJmmNewState();public static void main(String args[]) throws ParseException {
...
if (jjtc000) {
  ...
  static final public void ExpressionNR() throws ParseException {/*@bgen(jjtree) ExpressionNR */
  ASTExpressionNR jjtn000 = new ASTExpressionNR(JJTEXPRESSIONNR);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      if (jj_2_35(2)) {
...
if (jjtc000) {
  ...
  static final public void Lt() throws ParseException {/*@bgen(jjtree) Lt */
...
if (jjtc000) {
  ...
  static final public void LtNR() throws ParseException {/*@bgen(jjtree) LtNR */
  ASTLtNR jjtn000 = new ASTLtNR(JJTLTNR);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      if (jj_2_39(2)) {
...
if (jjtc000) {
  ...
  static final public void AddSubNR() throws ParseException {
    if (jj_2_40(2)) {
...
if (jjtc002) {
  ...
  static final public void MultDiv() throws ParseException {/*@bgen(jjtree) MultDiv */
                  ASTMultDiv jjtn000 = new ASTMultDiv(JJTMULTDIV);
                  boolean jjtc000 = true;
                  jjtree.openNodeScope(jjtn000);Token t;
    try {
...
if (jjtc000) {
  ...
  static final public void MultDivNR() throws ParseException {/*@bgen(jjtree) MultDivNR */
                    ASTMultDivNR jjtn000 = new ASTMultDivNR(JJTMULTDIVNR);
                    boolean jjtc000 = true;
                    jjtree.openNodeScope(jjtn000);Token t;
    try {
      if (jj_2_42(2)) {
        jj_consume_token(ASTRSK);
        t = jj_consume_token(INTEGERLITERAL);
jjtn000.setVal(Integer.parseInt(t.image));
        MultDivNR();
      } else if (jj_2_43(2)) {
...
if (jjtc000) {
 ...
 {
    if (jj_scan_token(SLSH)) return true;
 ...
 {
    if (jj_scan_token(ASTRSK)) return true;
    if (jj_scan_token(INTEGERLITERAL)) return true;
    return false;
  }
  ...
  static private boolean jj_3_20()
 {
  ...
  static public JmmNewTokenManager token_source;
  ...
  public JmmNew(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public JmmNew(java.io.InputStream stream, String encoding) {
    ...
    token_source = new JmmNewTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public JmmNew(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public JmmNew(JmmNewTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(JmmNewTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
